...
from app01.forms import PermissionListForm
from app01.models import User,RoleList,PermissionList
...
def NoPermission(request):
    ...
    return render_to_response('managecenter/permission.no.html',kwvars,RequestContext(request))
...
def AddPermission(request):
    ...
    return render_to_response('managecenter/permission.add.html',kwvars,RequestContext(request))
...
def ListPermission(request):
    ...
    return render_to_response('managecenter/permission.list.html',kwvars,RequestContext(request))
...
def EditPermission(request,ID):
    ...
    return render_to_response('managecenter/permission.edit.html',kwvars,RequestContext(request))
